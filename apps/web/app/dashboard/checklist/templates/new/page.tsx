...
import { checklistAPI, CreateChecklistTemplatePayload, ItemType } from "@/lib/frontend/api-client";
...
export default function NewChecklistTemplatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      setLoading(true);
      await checklistAPI.createTemplate(currentOrganization.id, payload);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="max-w-2xl space-y-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">{t("checklist.newTemplate")}</CardTitle>
          </CardHeader>
