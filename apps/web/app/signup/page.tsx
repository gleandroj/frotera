...
export default async function SignupPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-20 xl:px-24 bg-gradient-to-br from-green-600 to-blue-700 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 text-white">
            <h2 className="text-4xl font-bold leading-tight">
              {t("auth.branding.signup.heroTitle")}
            </h2>
            ...
            <div className="grid grid-cols-1 gap-4 pt-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg">{t("auth.branding.signup.features.quickSetup")}</span>
              </div>
            </div>
          </div>
        </div>
